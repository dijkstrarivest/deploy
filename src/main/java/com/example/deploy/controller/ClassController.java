package com.example.deploy.controller; // Declaração do pacote onde este controlador está localizado.
...
import com.example.deploy.model.Class; // Importa a classe de modelo Class.
import com.example.deploy.repository.ClassRepository; // Importa o repositório de classes.
