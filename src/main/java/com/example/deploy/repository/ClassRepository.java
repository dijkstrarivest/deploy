package com.example.deploy.repository; // Declaração do pacote onde esta interface de repositório está localizada.
...
import com.example.deploy.model.Class; // Importa a classe de modelo Class para especificar a entidade relacionada.
